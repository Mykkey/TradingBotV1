...
# positive. Trained by ml/train_alpha.py (python -m tradingbot train-alpha).
import json
import logging
...
from tradingbot.alphas.factors import feature_frame
from tradingbot.alphas.signals import mean_reversion_score, momentum_score
